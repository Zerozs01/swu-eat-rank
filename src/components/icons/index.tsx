...
export function DiceIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg 
      className={className} 
      width={size} 
...
export function FoodIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg 
      className={className} 
      width={size} 
...
export function HeartIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg 
      className={className} 
      width={size} 
...
export function MailIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg 
      className={className} 
      width={size} 
