...
export const uploadMenuImage = onRequest({ region: 'asia-east1', cors: ['https://swu-eat-rank.web.app', 'https://swu-eat-rank.firebaseapp.com', 'http://localhost:5173'] }, async (req, res) => {
    // Allow only POST
    if (req.method !== 'POST') {
        res.set('Allow', 'POST');
